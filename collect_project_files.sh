...
tree /mnt/c/Users/Lauanny/Desktop/melo/rrc/agile/project/amazonia_pet_supplies -I "node_modules|tmp|vips-8.13.3|public|storage|log|coverage|*.log|*.tmp|.vscode|.idea|*.sublime-project|*.sublime-workspace|Thumbs.db|.DS_Store|doc|yardoc|*.rdoc|*.ri" > /mnt/c/Users/Lauanny/Desktop/melo/rrc/agile/project/amazonia_pet_supplies/project_tree.txt
